...
import 'package:passelivre/dados.responsavelRg.dart';
import 'package:passelivre/dados.rg.dart';

class DadosCpfResponsavel extends StatefulWidget {
  @override
  State<StatefulWidget> createState() => new _DadosCpfResponsavelState();
}

class _DadosCpfResponsavelState extends State<DadosCpfResponsavel> {
  int _index = 0;
  File _imageCpf;
          ...
          child: Column(
            children: [
              ...
              Padding(
                padding: const EdgeInsets.all(10.0),
                child: Text(
                  "AGORA  VAMOS TIRAR UMA FOTO DO CPF DO SEU RESPONSÁVEL PARA COMPLETAR O CADASTRO ",
                  style: TextStyle(
              ...
              Container(),
              Text(
                "Agora com CPF DO SEU RESPONSÁVEL em mãos vamos tirar uma foto dele?",
